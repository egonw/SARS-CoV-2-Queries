...
### curl
```shell
curl -s https://raw.githubusercontent.com/egonw/SARS-CoV-2-Queries/master/sparql/articleCountPerGene.rq | sed 's+<lang/>+es+' > articleCountPerGene.rq
