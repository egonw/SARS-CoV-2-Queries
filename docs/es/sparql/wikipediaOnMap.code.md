...
<table>
  ...
  <tr>
    <td>https://es.wikipedia.org/wiki/Pandemia_de_COVID-19_en_la_Rep%C3%BAblica_Popular_China</td>
  ...
  <tr>
    <td>https://es.wikipedia.org/wiki/Pandemia_de_COVID-19_en_Malta</td>
