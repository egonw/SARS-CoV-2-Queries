...
### curl
```shell
curl -s https://raw.githubusercontent.com/egonw/SARS-CoV-2-Queries/master/sparql/virusGenesAll.rq | sed 's+<lang/>+ja+' > virusGenesAll.rq
