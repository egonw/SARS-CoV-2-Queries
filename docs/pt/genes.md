...
[ [en](../genes.md) [ja](../ja/genes.md) [es](../es/genes.md) **pt**  ]
...
O <a name="tp2">RNA</a> do SARS-CoV-2 já foi sequenciado. Dessa forma, os <a name="tp3">quadros abertos de leitura</a>  (ORFs) são conhecidos e identificados.
