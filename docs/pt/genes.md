...
O <a name="tp2">RNA</a> dO SARS-CoV-2 já foi sequenciado. Dessa forna, os <a name="tp3"> quadros abertos de leitura</a> (ORFs) são conhecidos e identificados.
Podemos consultar a informação sobre <a name="tp4">genes</a> na Wikidata com essa busca:
