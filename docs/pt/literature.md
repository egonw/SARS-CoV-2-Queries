...
[ [en](../literature.md) [ja](../ja/literature.md) [es](../es/literature.md) **pt**  ]

# Literatura

Estas buscas retornoma os últimos 10 <a name="tp1">artigos</a> sobre uma série de temas.Não é um substituto para o [Scholia](https://scholia.toolforge.org/) [<a href="#citeref1">1</a>], que tem uma visão muito mais rica da  <a name="tp1">literatura</a> sobre el tema. Cada seção inclui uma ligação à página do Scholia para esse tema. As consultas feitas aqui são básicas e usam somente a propriedade "tópico principal da obra".
...
<table>
  ...
  <tr><td colspan="2">null <a href="sparql/litSARSCoV2Genes.code.html">sparql/litSARSCoV2Genes.rq</a></td></tr>
</table>
