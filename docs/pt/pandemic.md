...
[ [en](../pandemic.md) [ja](../ja/pandemic.md) [es](../es/pandemic.md)  ]
...
O SARS-CoV-2 também sobrevive por um tempo ambiente após ser expelido. Podemos, com essa busca, listar artigos referentes à permanência do vírus em< <a name="tp2">superficies planas</a>:
