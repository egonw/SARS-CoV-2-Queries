...
<table>
  ...
  <tr><td colspan="2">This table is truncated. See the full table at [sparql/antibodies.rq](sparql/antibodies.code.html).</td></tr>
</table>
...
<table>
  ...
  <tr><td colspan="2">This table is truncated. See the full table at [sparql/clinicalTrialsByIntervention.rq](sparql/clinicalTrialsByIntervention.code.html).</td></tr>
</table>
