...
### curl
```shell
curl -s https://raw.githubusercontent.com/egonw/SARS-CoV-2-Queries/master/sparql/antibodyCounts.rq | sed 's+<lang/>+en+' > antibodyCounts.rq
