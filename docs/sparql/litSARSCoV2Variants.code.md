...
### curl
```shell
curl -s https://raw.githubusercontent.com/egonw/SARS-CoV-2-Queries/master/sparql/litSARSCoV2Variants.rq | sed 's+<lang/>+en+' > litSARSCoV2Variants.rq
