...
For the coronaviruses we can list the <a name="tp4">NCBI Taxonomy</a> [<a href="#citeref1">1</a>] identifiers with:
...
1. <a name="citeref1"></a>Federhen S. The NCBI Taxonomy database. NAR. 2012 Jan;40(Database issue):D136-43.  doi:[10.1093/NAR/GKR1178](https://doi.org/10.1093/NAR/GKR1178) ([Scholia](https://tools.wmflabs.org/scholia/doi/10.1093/NAR/GKR1178))
